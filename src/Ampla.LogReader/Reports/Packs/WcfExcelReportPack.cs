    ...
    public class WcfExcelReportPack : ReportPack
    {
        ...
        public override void Render()
        {
            ...
            using (IExcelSpreadsheet excel = ExcelSpreadsheet.CreateNew(fileName))
            {
                ...
                DataTable wcfCalls = new WcfCallTable(reader.Entries, timeZoneInfo).Data;
                ...
                DataTable locations = new WcfLocationsTable(reader.Entries).Data;
                excel.WriteDataToWorksheet(locations, "Locations");
            }
        }
    }
}